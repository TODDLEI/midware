...
public class Mozeo {
    ...
    public String send(String to, String unixTime, String msgId, String msg, String stop) {
        logger                              = new MidwareLogger(Mozeo.class.getName());
        try {
            ...
            smsUrl                          +="?to="+to+"&stop="+stop+"&username="+userName+"&password="+password+"&companykey="+companyKey+"&messageid="+msgId+"&messagebody="+msg+"&datetimestamp="+unixTime;
            //logger.debug(smsUrl);
